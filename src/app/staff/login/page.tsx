  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        {!selectedRole && (
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button
              ...
              className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-100 dark:border-gray-800 p-6 text-center hover:border-orange-300 dark:hover:border-orange-700 hover:shadow-lg transition-all group cursor-pointer"
            >
              <div className="w-14 h-14 bg-orange-100 dark:bg-orange-950 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:bg-orange-600 transition-colors">
              ...
              <p className="text-[11px] text-gray-400 mt-1">Full dashboard access</p>
            </button>

            <button
              onClick={() => selectRole("staff")}
              className="bg-white dark:bg-gray-900 rounded-2xl border-2 border-gray-100 dark:border-gray-800 p-6 text-center hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-lg transition-all group cursor-pointer"
            >
              <div className="w-14 h-14 bg-blue-100 dark:bg-blue-950 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:bg-blue-600 transition-colors">
              ...
              <p className="text-[11px] text-gray-400 mt-1">Order management</p>
            </button>
          </div>
        )}
        ...
        {/* ── Login form ───────────────────────────────────── */}
        {selectedRole && (
          <div className={`bg-white dark:bg-gray-900 rounded-3xl shadow-xl overflow-hidden border-2 ${
            isManager
            ...
            <div className={`px-8 py-4 flex items-center gap-3 border-b ${
              ...
              <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${
                isManager ? "bg-orange-600" : "bg-blue-600"
              }`}>
                {isManager
              ...
              <button
                ...
                className="text-xs font-bold text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors shrink-0 px-2 py-1 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                Change
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full text-white py-3.5 rounded-xl font-black text-sm transition-colors shadow-lg flex items-center justify-center gap-2 ${
                  isManager
